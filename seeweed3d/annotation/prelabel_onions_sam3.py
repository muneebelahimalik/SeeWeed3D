...
CONFIG = {
    ...
    "ONLY_FRAMES": {"Visit2_20260210_164149": ["1205-1950"]},
...
def prelabel_session(sid, session_dir, out_root, cfg, predictor, sam_fn):
    ...
    # stretch rather than the first N frames of the whole session - which on a
    # split-zone drive would be entirely the wrong zone.
