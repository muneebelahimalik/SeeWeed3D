...
CONFIG = {
    ...
    "DATASET_DIR": r"E:\Dataset_Vidalia\training_onion__only_all_sessions_final_dataset",

    # Sessions root(s). "" reuses whatever make_dataset.py recorded.
    "IMAGES_ROOT": "",

    # One folder per run - do not reuse, or you lose the comparison.
    "RUN_DIR": r"E:\Dataset_Vidalia\training_onion__only_all_sessions_final_dataset\rfdetr_onion_v1",
